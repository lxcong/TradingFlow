/**
 * TradingFlow — a multi-agent financial analysis workflow for Claude Code.
 *
 ...
 *
 * Run it:
 *   Workflow({ scriptPath: ".../tradingflow.workflow.js",
...
//   • a free-text string  — the trailing text of the `/tradingflow NVDA as of 2026-05-28` command
...
const outDir = _obj.outDir || 'tradingflow-reports'
...
<main>
  ...
  <footer>Generated by the TradingFlow workflow · ${esc(r.ticker)} · ${esc(r.date)}</footer>
</main>
</body>
</html>
`
